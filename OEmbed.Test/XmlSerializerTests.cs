...
public class XmlSerializerTests
{
    ...
    public void BasicTest()
    {
        ...
        using FileStream fs = File.OpenRead(Path.Combine(_fixturesPath, "basic_sample.xml"));
    ...
    public void RichTest()
    {
        ...
        using FileStream fs = File.OpenRead(Path.Combine(_fixturesPath, "rich_sample.xml"));
