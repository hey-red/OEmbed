...
public class CacheTests
{
    ...
    public async Task GetAsyncNullTest()
    {
        ...
        string key = _cacheKey.CreateKey("https://www.youtube.com/watch?v=D1PvIWdJ8xo");
    ...
    public async Task GetSetAsyncValueTest()
    {
        ...
        await cache.SetAsync<Rich>(key, new Rich());
    ...
    public async Task AddOrGetExistingAsyncTest()
    {
        ...
        Rich? item = await cache.AddOrGetExistingAsync(url, _ => Task.FromResult<Rich?>(expected));

        string key = _cacheKey.CreateKey(url);
    ...
    public async Task AddOrGetExistingAsyncNullTest()
    {
        ...
        Rich? item = await cache.AddOrGetExistingAsync(url, url => Task.FromResult<Rich?>(null));
    ...
    public async Task MultiThreadingTest()
    {
        ...
        _output.WriteLine("Total results: " + results!.Length);
