...
public class RutubeTests
{
    ...
    [InlineData("https://rutube.ru/shorts/9253c0ad51a1778227d0976d1f5d1b79/")]
    ...
    {
        var result =
            await _oEmbedConsumer.RequestAsync<Video>("https://rutube.ru/video/755ec2d4b19d2374d6c78890dbaad7fe/");
    ...
    [Fact]
    public async Task RequestShortsTest()
    {
        var result =
            await _oEmbedConsumer.RequestAsync<Video>("https://rutube.ru/shorts/9253c0ad51a1778227d0976d1f5d1b79/");
