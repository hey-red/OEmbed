...
public class TwitterTests
{
    ...
    {
        var result = await _oEmbedConsumer.RequestAsync<Rich>("https://x.com/norafawn/likes", 400);
    ...
    {
        var result =
            await _oEmbedConsumer.RequestAsync<Rich>("https://x.com/Kuvshinov_Ilya/status/1569356877896777734", 400);
    ...
    {
        var provider = new TwitterProvider(new ProviderOptions
        {
